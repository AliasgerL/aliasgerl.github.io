...
import { GiDisc, GiFoodTruck, GiPayMoney } from 'react-icons/gi';
import { FaMedal, FaPercent, FaTruckFast } from 'react-icons/fa6';
        ...
        <div className='container'>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 items-center'>
                ...
                <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                    ...
                    <p data-aos="fade-up" className='text-sm text-gray-500 tracking-wide leading-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis incidunt numquam ratione nemo, minus similique!</p>
